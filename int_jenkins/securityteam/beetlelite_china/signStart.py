...
class sign_apk():
	...
	def replace(self):
		docmd('cp /local/int_tools/securityteam/beetlelite_china/misc_sign_beetlelite_custpack.sh .')
                os.chdir('build/target/product')
                docmd('zip -r security_bc.zip security')
                os.chdir(self.tmpdir)
		docmd('rm -rf build/target/product/security/*')
		docmd('cp /local/int_tools/securityteam/beetlelite_china/TCT_ReleaseKeys.zip build/target/product/security/')
