...
class sign_apk():
	...
	def replace(self):
		docmd('cp /local/int_tools/securityteam/pixo7/sign_target_files_apks.py .')
		...
		docmd('cp /local/int_tools/securityteam/pixo7/TCL_ReleaseKeys.zip build/target/product/security/')
...
if __name__ == "__main__":
	...
	if len(sys.argv) != 3:
		print "You must give two argument!"
		sys.exit(1)
