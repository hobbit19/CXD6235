...
-e Browser.apk=build/target/product/security/platform \
-e JrdWeather.apk=build/target/product/security/platform \
-e JrdWifiTransfer.apk=build/target/product/security/platform \
-e FrequentContactsWidget.apk=build/target/product/security/platform \
