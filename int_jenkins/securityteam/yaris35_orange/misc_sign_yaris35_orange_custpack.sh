...
-e JrdElabel.apk=build/target/product/security/platform \
-e JrdFota.apk=build/target/product/security/platform \
-e LatinIME.apk=build/target/product/security/platform \
-e JrdSdcardUpgrade.apk=build/target/product/security/platform \
-e Rcse.apk=build/target/product/security/platform \
-e JrdFileOperation.apk=build/target/product/security/platform \
