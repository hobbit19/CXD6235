...
class ModemPatchMerge(CheckFile,dotProjectDb,checkPatchInfor):
		...
		self.proj = 'pixi4-5-4g-orange'
		self.dept = 'sdd2'
		self.manifestdir = 'alps'
		self.sharefoldname = 'pixi4-5-4g-orange'
		self.marketname = 'pixi4-5-4g-orange'
		self.__project = 'jhz6735_65t_m'
		self.modem_mak = 'JHZ6735_65T_M'
