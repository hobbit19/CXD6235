...
class ModemPatchMerge(CheckFile,dotProjectDb,checkPatchInfor):
    def __init__(self,basedir='/local'):
        ...
        self.proj = 'pixi3-45-4g-volte'
        self.dept = 'alps'
        self.sharefoldname = 'pixi3-45-4g-volte'
        self.marketname = 'pixi3-45-4g-volte'
        self.__project = 'JHZ6735M_65C_VL_L'
	self.modem_mak = 'JHZ6735M_65C_VL_L'
