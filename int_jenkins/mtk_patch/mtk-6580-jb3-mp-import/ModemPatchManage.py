...
class ModemPatchMerge(CheckFile,dotProjectDb,checkPatchInfor):
	...
	self.repopath = '/local/tools/repo/repo'
        ...
        wb = xlrd.open_workbook('%s/mtk-6580-jb3-mp-import.xls' % getoutput("dirname %s" % (sys.argv[0])))
        ...
        self.__ModemCode = self.__importCode + "/MT6580_Modem"
    ...
    def repo_code(self, CodeDir, ModemDir, CodeBranchName):
        ...
        os.chdir(CodeDir)
        if os.path.exists(CodeDir + "/MT6580_Modem" + "/.git") == False:
            os.system('git clone git@10.92.32.10:/mtk6580/modem.git MT6580_Modem')
            os.chdir(ModemDir)
	...
	for branch in self.__DriveOnlyBranch:
            ...
            DriveModemCode = DriveOnlyCode + "/MT6580_Modem"
    ...
    def __takePatch(self,codedir,patchNo=''):
        ...
        os.system('git rm %s/mtk_rel/JHZ6580_WE_L_GPRS/DEFAULT/tst/database/BPLGUInfoCustomApp*' %self.__ModemCode)
        os.system('git rm %s/mtk_rel/JHZ6580_WE_L_GPRS/DEFAULT/tst/database/_BPLGUInfoCustomApp*' %self.__ModemCode)
        os.system('git rm %s/mtk_rel/JHZ6580_WE_L_HSPA/DEFAULT/tst/database/BPLGUInfoCustomApp*' %self.__ModemCode)
        os.system('git rm %s/mtk_rel/JHZ6580_WE_L_HSPA/DEFAULT/tst/database/_BPLGUInfoCustomApp*' %self.__ModemCode)
    ...
    def __compile(self, CodeDir):		
        ...
        print "building......"
        if False == self.__debug:
            buildStatus = getstatusoutput("./make.sh \"JHZ6580_WE_L_HSPA.mak\" new")
    ...
    def __copyModemImage(self):
        mdImg = 'mdImg'
        OUT_PATH1 = 'MT6580_Modem/build/JHZ6580_WE_L_HSPA/DEFAULT/bin'
        OUT_PATH2 = 'MT6580_Modem/build/JHZ6580_WE_L_HSPA/DEFAULT/tst/database'
        OUT_PATH3 = 'MT6580_Modem/mtk_rel/JHZ6580_WE_L_HSPA/DEFAULT/tst/database'
        OUT_PATH4 = mdImg
	...
	dearName = sys.argv[4].split('@')[0]
		...
		if True == self.getFileLibNvram(self.__ModemCode,projectname):
            ...
            a = u"\\\\10.92.32.12\\RDhzKM\\4-SWD1\\B-技术文档\\A-MTK源代码\\6580\\Patch"
            mailBody.append('<p align=\'Left\'><b>You can also find this patch (P%s) in:<font color="#FF0000">%s</font></b></p>' % (patchNo, a))

            mailBody.append('<p align=\'Left\'><b>After you complete to merge the MTK6580 Pixi3-5/55 modem patch P%s,</b></p>' % patchNo)
