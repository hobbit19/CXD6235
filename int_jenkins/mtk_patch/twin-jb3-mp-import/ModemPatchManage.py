...
class ModemPatchMerge():
    ...
    def __takePatch(self,patchNo=''):
        ...
        os.system('git rm %s/mtk_rel/JRDHZ72_WE_TWIN_JB3_GPRS/DEFAULT/tst/database/BPLGUInfoCustomApp*' %self.__ModemCode)
        os.system('git rm %s/mtk_rel/JRDHZ72_WE_TWIN_JB3_GPRS/DEFAULT/tst/database/_BPLGUInfoCustomApp*' %self.__ModemCode)
        os.system('git rm %s/mtk_rel/JRDHZ72_WE_TWIN_JB3_HSPA/DEFAULT/tst/database/BPLGUInfoCustomApp*' %self.__ModemCode)
        os.system('git rm %s/mtk_rel/JRDHZ72_WE_TWIN_JB3_HSPA/DEFAULT/tst/database/_BPLGUInfoCustomApp*' %self.__ModemCode)
    ...
    def __compile(self):		
        ...
        print "building......"
        if False == self.__debug:
            buildStatus = getstatusoutput("./make.sh \"JRDHZ72_WE_TWIN_JB3_HSPA.mak\" new")
    ...
    def __copyModemImage(self):
        mdImg = 'mdImg'
        OUT_PATH1 = 'MT6572_Modem/build/JRDHZ72_WE_TWIN_JB3_HSPA/DEFAULT/bin'
        OUT_PATH2 = 'MT6572_Modem/build/JRDHZ72_WE_TWIN_JB3_HSPA/DEFAULT/tst/database'
        OUT_PATH3 = 'MT6572_Modem/mtk_rel/JRDHZ72_WE_TWIN_JB3_HSPA/DEFAULT/tst/database'
        OUT_PATH4 = mdImg
        PATH1 = "JRDHZ72_WE_TWIN_JB3_HSPA"

        os.chdir(self.__importCode)
        os.system('rm -rfv %s'%mdImg)
        os.system('mkdir %s' %mdImg)
        
        os.system('cp %s/JRDHZ72_WE_TWIN_JB3_HSPA_PCB01_MT6572_S00.elf %s' %(OUT_PATH1,OUT_PATH4))
        os.system('cp %s/JRDHZ72_WE_TWIN_JB3_HSPA_PCB01_MT6572_S00.MOLY_WR8_*.bin %s/modem_1_wg_n.img'%(OUT_PATH1,OUT_PATH4))
        os.system('cp %s/JRDHZ72_WE_TWIN_JB3_HSPA.mak %s/modem_1_wg_n.mak'%(OUT_PATH1,OUT_PATH4))         
    ...
    def __pushModemImage(self,patchNo):
        ...
        if action == "yes":
            path = 'custom/common/modem/jrdhz72_we_twin_jb3_hspa'      
            ...
            os.system('git rm -rf custom/common/modem/jrdhz72_we_twin_jb3_hspa/*')
