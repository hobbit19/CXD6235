...
class contextFactory(object):
	...
	def __gene_state__(self):
		...
		if _oper:
			self.state = eval("%s('%s')" % (_oper,img_dir))
			_next = self.__next__()
			if _next:
				return self.state
			else:
...
if __name__ == '__main__':
	...
	#img_dir = '/home/swd3/android-sdk-linux/GSIs/TCT_ROM/YA1039064000.mbn'
	#img_dir = '/home/swd3/android-sdk-linux/GSIs/8.1_r4_arm_a/system-aosp_arm_a-2019-09-05.img'
	img_dir = '/home/swd3/android-sdk-linux/GSIs/8.1_r4_arm_a/system-aosp_arm_a-2019-11-05.img'
