#!/usr/bin/php -q 
<?php
require_once('inc/conf_sdd1.inc');
...
do{
    ...
    $git_push_nothin = "git push --no-thin ssh://".$author_name."@10.92.32.10:29418/".$git_path_name." HEAD:refs/for/".$result_git_path_name;
...
if (!empty($mtk_patch_number)&&!empty($patchtype)){
	$arr_mtkpatch_recipients = array("renzhi.yang.hz@tcl.com","shie.zhao@tcl.com","shuangyan.he@tcl.com",$author_email);
