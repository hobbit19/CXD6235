...
class IntegrityItem(Storage):
    ...
    def time_to_set_assigned(self):
       if 'Time To Set Assigned' in self.keys():
           return self['Time To Set Assigned'].dateTime.value
       return ''


    @property
    def time_to_set_verified_sw(self):
	if 'Time To Set Verified_SW' in self.keys():
	    return self['Time To Set Verified_SW'].dateTime.value
	return ''

    @property
    def time_to_set_resolved(self):
	if 'Time To Set Resolved' in self.keys():
	    return self['Time To Set Resolved'].dateTime.value
	return ''

    @property
    def deadline(self):
       if 'Deadline' in self.keys():
           return self['Deadline'].dateTime.value
       return ''
    ...
    def relate_FR(self):
        if 'Backward Relate Task' in self.keys():
            return self['Backward Relate Task'].Item
        return ''

    @property
    def relate_task(self):
        if 'Relate Task' in self.keys():
            return self['Relate Task'].Item
        return ''
    ...
    def branch(self): # branch is a RelatedItem
        if 'singleBranch' in self.keys():
            return self['singleBranch'][1].value  ## it's a string here
        if 'Branch' in self.keys():
            return self['Branch'][1].value  ## it's a list here
        return ''
