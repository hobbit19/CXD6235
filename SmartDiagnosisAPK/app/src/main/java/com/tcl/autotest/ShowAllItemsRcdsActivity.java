...
public class ShowAllItemsRcdsActivity extends Activity {

	private static final String TAG = "ShowAllItemsRcdsActivity";
	EditText edShowRcds;
	String wholeName;
	StringBuffer sb;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showallitemsrcds);
		...
		wholeName = bundle.getString("RCD_FILE_ALL_ITEMS_NAME");
