...
public class ShowManuRcdsActivity extends Activity {

	private static final String TAG = "ShowManuRcdsActivity";
	EditText edShowRcds;
	String wholeName;
	StringBuffer sb;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showmanurcds);
		...
		wholeName = bundle.getString("RCD_FILE_MANU_NAME");
		Tool.toolLog(TAG + " 121212121 wholeName " + wholeName);
	...
	private void getTextContext() {
		...
		try {
			...
			Tool.toolLog(TAG + " 1212121212 " + sb.toString());
