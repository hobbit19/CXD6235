...
public class Wifi_2_4GTest extends Test implements DownTimeCallBack {
    private final static String TAG = "Wifi2.4GTest";
    ...
    public Wifi_2_4GTest(ID id, String name) {
        super(id, name);
        this.name = name;
    }
...
//		Tool.toolLog(TAG + " onTick ...");
    ...
    private void handleScanResultsAvailable() {
        ...
        Comparator<ScanResult> comp = new ScanResultcomparator2();
...
class ScanResultcomparator2 implements Comparator<ScanResult> {
    @Override
